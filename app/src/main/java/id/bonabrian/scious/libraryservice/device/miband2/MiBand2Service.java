...
import static id.bonabrian.scious.libraryservice.service.btle.AbsBTLEDeviceSupport.BASE_UUID;
...
public class MiBand2Service {
    public static final String DUMMY_MAC_ADDRESS = "88:0F:00:00:00:00";
    ...
    public static final byte COMMAND_SET_HEARTRATE_CONTINUOUS = 0x1;
    public static final byte COMMAND_SET_HEARTRATE_MANUAL = 0x2;
    ...
    public static final byte[] COMMAND_ENABLE_HEARTRATE_SLEEP_MEASUREMENT = new byte[]{0x15, 0x00, 0x01};
    public static final byte[] COMMAND_DISABLE_HEARTRATE_SLEEP_MEASUREMENT = new byte[]{0x15, 0x00, 0x00};
