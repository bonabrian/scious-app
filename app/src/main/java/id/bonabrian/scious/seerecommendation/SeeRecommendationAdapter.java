...
public class SeeRecommendationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SeeRecommendationAdapter(List<Recommended> recommendedList, Context context, RecommendedItemListener recommendedItemListener) {
        this.recommendedList = recommendedList;
        this.context = context;
        this.recommendedItemListener = recommendedItemListener;
    }

    public SeeRecommendationAdapter(List<Recommended> recommendedList, Context context) {
        this.recommendedList = recommendedList;
        this.context = context;
    }
